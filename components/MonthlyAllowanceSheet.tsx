                    ...
                    <table id="allowance-sheet-table" className="w-full min-w-[1200px] border-collapse">
                        <thead>
                            <tr className="bg-green-700 text-white">
                                ...
                                {/* ADDED COLUMNS */}
                                <th className={`${SUMMARY_HEADER_CLASS} ${COL_W_TARGET} bg-cyan-600 border-l border-white/10 p-0`}>
                                ...
                                return (
                                    <React.Fragment key={emp.id}>
                                        <tr className={`group ${isEven ? 'bg-green-50/30' : 'bg-white'}`}>
                                            ...
                                            <td className="p-0 border-b border-l border-gray-200 align-middle w-[60px] min-w-[60px] h-full relative">
                                                {(totalPermit > 0 && totalOvertime > 0) ? (
                                                    ...
                                                    <div className="flex items-center justify-center h-full w-full p-2">
                                                        {totalPermit > 0 && <span className="font-bold text-xs text-purple-900 bg-purple-100 px-1.5 py-0.5 rounded border border-purple-200">P: {totalPermit}</span>}
                                                        {totalOvertime > 0 && <span className="font-bold text-xs text-orange-900 bg-orange-100 px-1.5 py-0.5 rounded border border-orange-200">S: {totalOvertime}</span>}
                                            ...
                                            {/* --- NEW COLUMNS --- */}
                                            {/* NETTO/LORDO */}
                                            <td className={`p-0 border-b border-gray-200 text-center relative group/target ${COL_W_TARGET} border-l border-gray-100`}>
