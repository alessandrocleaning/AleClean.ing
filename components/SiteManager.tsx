          ...
          {filteredSites.map((site, index) => {
            ...
            return (
                <div 
                    ...
                    className={`
                        flex items-center gap-4 p-4 rounded-xl border transition-all select-none group
                ...
                >
                    ...
                    {/* Numeric Indicator */}
                    <div className="text-xs font-black text-gray-300 w-8 text-center hidden md:flex items-center justify-center bg-gray-50 rounded-md h-8 group-hover:text-[#004aad] group-hover:bg-blue-50 transition-colors">
                        {index + 1}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                        {isEditing ? (
                            ...
                            <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-6">
                                <div className="font-bold text-gray-800 text-base md:text-lg truncate flex items-center gap-2">
