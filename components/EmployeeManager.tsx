...
export const EmployeeManager: React.FC<Props> = ({ employees, sites, setEmployees }) => {
    ...
    return (
        <div className="space-y-8 animate-fade-in pb-20 relative">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center bg-white p-4 rounded-xl border border-gray-200 shadow-sm gap-4 mb-4">
                ...
                <div className="relative w-full md:w-64">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:border-[#004aad] focus:ring-1 focus:ring-[#004aad] outline-none transition-all placeholder-gray-400 font-medium"
                    />
                </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              `}
                            >
                                ...
                                {isOpen && (
                                    <div className="p-4 md:p-6 bg-gray-50/50 border-t border-gray-100 flex flex-col gap-6 animate-fade-in-up">
                                        <div className="flex-1 flex flex-col gap-6">
                                         ...
                                         <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
                                             <button 
                                                 onClick={() => setIsCostConfigOpen(!isCostConfigOpen)} 
                                                 className="w-full p-4 flex items-center justify-between bg-white hover:bg-gray-50 transition-colors group cursor-pointer"
                                             >
                                                 ...
                                                 {isCostConfigOpen ? <ChevronUp className="w-4 h-4 text-gray-400" /> : <ChevronDown className="w-4 h-4 text-gray-400" />}
                                             </button>
                                             
                                             {isCostConfigOpen && (
                                                 <div className="p-4 pt-0 border-t border-gray-100 space-y-4 animate-fade-in bg-white">
                                                     ...
                                                     <div className="mt-4">
                                                         ...
                                                         <div className="space-y-2">
                                                             {([
                                                                 ...
                                                                 { key: 'includeExtraHours', label: 'Diff. negativa (15 €)' },
                                                                 { key: 'includeOvertime', label: 'Straordinari (15 €)' },
